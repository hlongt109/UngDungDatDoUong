package com.longthph30891.ungdungdatdouong.utilities.api;

import com.longthph30891.ungdungdatdouong.utilities.Constant.AppInfo;
import com.longthph30891.ungdungdatdouong.utilities.Helper.Helpers;
...
public class CreateOrder {
    ...
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Thanh toán đơn hàng #" + Helpers.getAppTransId();
