...
import static com.duongnd.sipdrinkadmin.activity.chatwindo.reciverIImg;
import static com.duongnd.sipdrinkadmin.activity.chatwindo.senderImg;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                new AlertDialog.Builder(context).setTitle("Xóa")
                        .setMessage("Bạn có muốn xóa tin nhắn?")
        ...
        if (holder.getClass()==senderVierwHolder.class){
            ...
            viewHolder.msgtxt.setText(messages.getMessage());
            Glide.with(context).load(reciverIImg).into(viewHolder.circleImageView);
